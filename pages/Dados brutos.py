...
@st.cache_data # converte o arquivo pra CSV 
def converte_csv(df):
...
with st.sidebar.expander('Tipo de pagamento'):
    tipo_de_pagamento = st.multiselect('Selecione o tipo de pagamento',dados['Tipo de pagamento'].unique(),dados['Tipo de pagamento'].unique())
...
`Tipo de pagamento` in @tipo_de_pagamento and \
